...
class OSF_Admin_MegaMenu {
	...
	private function includes() { 
		include_once OM_PLUGIN_DIR . 'includes/admin/class-admin-form-process-handler.php';
		include_once OM_PLUGIN_DIR . 'includes/admin/class-admin-assets.php';
		include_once OM_PLUGIN_DIR . 'includes/admin/class-admin-menu.php';
	}
