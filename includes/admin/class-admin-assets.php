...
class OSF_Admin_Megamenu_Assets {
	...
	public static function enqueue_scripts( $page ) { 
		if ( $page === 'nav-menus.php' ) {  
			...
			wp_register_script( 'otf-megamenu', OM_PLUGIN_URI . 'assets/js/admin.js', array('jquery', 'backbone', 'underscore' ), '1.0.0', true );
			wp_localize_script( 'otf-megamenu', 'osf_memgamnu_params', apply_filters( 'osf_admin_megamenu_localize_scripts', array(
					'ajaxurl' => admin_url( 'admin-ajax.php' ),
					'i18n' => array(
							'close' => __( 'Close', 'opalmegamenu' ),
							'submit' => __( 'Save', 'opalmegamenu' )
						),
					'nonces' => array(
