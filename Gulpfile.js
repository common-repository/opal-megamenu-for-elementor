...
var paths = {
    ...
    "dist":"/Applications/XAMPP/xamppfiles/htdocs/wordpress/svn/opal-megamenu-for-elementor/trunk"
}
...
gulp.task( 'watch', [ 'babel-admin-elementor-frontend' ], function(){
    gulp.watch([
        path.join(folderPlugin, 'assets/babel/elementor/*.js'),
...
gulp.task( 'elementor-frontend', function() {
    return gulp.src( path.join(folderPlugin, 'assets/sass/frontend.scss') )
